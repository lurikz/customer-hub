...
export function getTaskStatusGroup(task: Task): StatusGroupId {
                    ...
                    <div className="flex-1 py-1">
                      ...
                      <div className="mt-2 flex flex-wrap items-center gap-4">
                        {task.execution_log && isPast(new Date(task.datetime)) && !isToday(new Date(task.datetime)) && (
                          <span className="text-[10px] font-bold text-red-600 bg-red-500/10 px-1.5 py-0.5 rounded uppercase">
        ...
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-hidden flex flex-col p-0">
          <DialogHeader className="p-6 pb-2 shrink-0 border-b">
            ...
            <DialogDescription className="sr-only">
              Visualização detalhada das tarefas para o dia selecionado.
            </DialogDescription>
          </DialogHeader>
